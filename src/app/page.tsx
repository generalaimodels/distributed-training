    ...
    <div className="page-shell">
      <section className="hero hero-home">
        <div className="hero-copy hero-home-copy">
          ...
          <h1>Premium technical reading surfaces for every Markdown tree in your repository.</h1>
          <p>
            Markdown, raw HTML, equations, code, media, citations, and folder-aware navigation now flow into one polished knowledge
            product instead of a generic documentation dump.
          </p>
